...
function truthCheck(collection, pre) {
  ...
  return collection.every(obj => obj.hasOwnProperty(pre) === true & falsyValues.includes(obj[pre]) === false ? true : false)
}
...
function addTogether() {
  ...
  if (args.some( element => typeof(element)!== 'number')){
    ...
    return x => addTogether(args[0],x) // this is the money maker. this is how he was able to get that second argument
  } else {
